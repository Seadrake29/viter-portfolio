...
const ServiceListTable = ({ setItemEdit, setIsModal }) => {
  ...
  const {
    ...
    queryKey: ["service", search.current.value, store.isSearch, isActive],
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `/rest/v1/controllers/developer/settings/service/search.php`, // url search
        `/rest/v1/controllers/developer/settings/service/page.php?start=${pageParam}`, // list page
  ...
  return (
    <>
      ...
      {store.archive && (
        <ModalArchive
          endpoint={`/rest/v1/controllers/developer/settings/service/active.php?serviceid=${id}`}
      ...
      {store.delete && (
        <ModalDelete
          endpoint={`/rest/v1/controllers/developer/settings/service/service.php?serviceid=${id}`}
          msg={`Are you sure want to delete this record?`}
          successMsg={`Successfully Delete.`}
          item={dataItem.service_title}
          queryKey={`service`}
        />
      )}
