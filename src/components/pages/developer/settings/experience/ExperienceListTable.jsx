...
const ExperienceListTable = ({ setItemEdit, setIsModal }) => {
  ...
  const {
    ...
    queryKey: ["experience", search.current.value, store.isSearch, isActive],
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `/rest/v1/controllers/developer/settings/experience/search.php`, // url search
        `/rest/v1/controllers/developer/settings/experience/page.php?start=${pageParam}`, // list page
      ...
      <div className="flex justify-between items-center py-3">
        <div className="flex items-center gap-x-3">
          ...
          <div className="relative w-28">
            ...
            >
              <optgroup label="Select a status" className="bg-secondary">
